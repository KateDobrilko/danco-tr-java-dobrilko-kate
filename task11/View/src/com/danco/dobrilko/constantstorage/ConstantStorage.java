package com.danco.dobrilko.constantstorage;
...
public class ConstantStorage {
	...
	public final static String SORT_ORDERS_BY_DATE = "Press 6  - Show  Orders Sorted By Date";
	public final static String SORT_ORDERS_BY_EXECUTION = "Press 7  - Show  Orders Sorted By Execution";
	public final static String SORT_ORDERS_BY_PRICE = "Press 8  - Show  Orders Sorted By Price";
	...
	public final static String SORT_REPLIES_BY_ALPHABET = "Press 2  - Show  Replies Sorted  By Alphabet";
	public final static String SORT_REPLIES_BY_NUMBER = "Press 3  - Show  Replies Sorted By Number";
	...
	public final static String SORT_BOOKS_BY_PRICE = "Press 4 - Show  Books Sorted By By Price";
	public final static String SORT_BOOKS_BY_NAME = "Press 5 - Show  Books Sorted By By Name";
	public final static String SORT_BOOKS_BY_PUBLICATION_DATE = "Press 6 - Show  Replies Sorted  By Publication Date";
