...
public class OrderingSystem  implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -1905086573793963707L;
	...
	public void executeOrder(int orderId, Store store) {
		...
		if (orderToExecute == null) {
			Logger logger = Logger.getLogger(OrderingSystem.class);
