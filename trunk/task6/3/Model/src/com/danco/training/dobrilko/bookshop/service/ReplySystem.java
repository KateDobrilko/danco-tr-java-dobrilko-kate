...
public class ReplySystem  implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3203319497398759805L;
	...
	public void executeReply(Store store, int id) {
		if (store != null) {
			...
			if (r == null) {
				Logger logger = Logger.getLogger(ReplySystem.class);
	...
	public String toString() {
		...
		replies.forEach((Reply reply) -> sb.append(reply.toString() + System.lineSeparator()));
		return sb.toString();
	}
