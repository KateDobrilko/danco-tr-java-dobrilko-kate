...
public class Book implements Serializable {
	...
	public Book(String name, String author, double price, GregorianCalendar dateOfPublication, int id) {
		this.name = name;
		this.author = author;
		this.price = price;
		this.inStore = false;
	...
	public Book(String name, String author, double price, int id, int yearOfAddition, int monthOfAddition, int dayOfAddition, int yearOfPublication, int monthOfPublication, int dayOfPublication) {
		...
		if (yearOfAddition == (-1)) {
			...
			boolean condition = ((currentMonth + currentYear * 12) - (additionMonth + additionYear * 12)) > PropertiesUtil.getMonthsToMarkUnclaimed();
