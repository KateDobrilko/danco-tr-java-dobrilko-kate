...
public class MenuCreator {
	...
	public static void createMenu() {
		...
		readAndWriteMenu.addMenuItem(new MenuItem(new WriteToFileAction(),"Press 0 - Write to file", mainMenu));
		readAndWriteMenu.addMenuItem(new MenuItem(new ReadFromFileAction(),"Press 1 - Read from file", mainMenu));
		readAndWriteMenu.addMenuItem(new MenuItem(null,"Press 3 - Exit", null));
		...
		orderingSystemMenu.addMenuItem(new MenuItem(new EditOrderAction(), "Press 9  - Edit Order", orderingSystemMenu));
		orderingSystemMenu.addMenuItem(new MenuItem(null, "Type 10 - Open Main Menu", mainMenu));
