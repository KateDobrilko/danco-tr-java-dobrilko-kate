...
public class BookShop implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3680060342799010840L;
	...
	public BookShop(Store store, OrderingSystem orderingSystem, ReplySystem replySystem) {
		this.store = store;
		this.orderingSystem = orderingSystem;
		this.replySystem = replySystem;
	...
	public String toString() {
		...
		sb.append(this.orderingSystem.toString() + System.lineSeparator() + System.lineSeparator());
		sb.append(this.replySystem.toString() + System.lineSeparator() + System.lineSeparator());
		sb.append(this.store.toString() + System.lineSeparator() + System.lineSeparator());
		return sb.toString();
	}
